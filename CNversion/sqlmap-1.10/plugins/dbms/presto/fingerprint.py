...
class Fingerprint(GenericFingerprint):
    ...
    def checkDbms(self):
        ...
        if result:
            ...
            if not result:
                warnMsg = '后端数据库管理系统 不是 %s' % DBMS.PRESTO
