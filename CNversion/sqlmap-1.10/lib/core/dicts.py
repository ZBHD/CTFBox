...
# 参考文献：http://stackoverflow.com/a/17672504
...
# 参考文献：https://www.ibm.com/support/knowledgecenter/SSGU8G_12.1.0/com.ibm.sqls.doc/ids_sqs_0147.htm
...
# 参考号：https://blog.jooq.org/tag/sysibm-sysdummy1/
FROM_DUMMY_TABLE = {
...
HEURISTIC_NULL_EVAL = {
    ...
    DBMS.MYSQL: "IFNULL(QUARTER(NULL),NULL XOR NULL)",  # 注意：以前的形式（即 QUARTER(NULL XOR NULL)）很糟糕，因为某些优化引擎错误地将 QUARTER(NULL XOR NULL) 评估为 0
    ...
    DBMS.CRATEDB: "MD5(NULL~NULL)",  # 注意：NULL~NULL 也在 H2 和 Ignite 上进行评估
...
# 参考号：http://www.w3.org/TR/1999/REC-html401-19991224/sgml/entities.html
