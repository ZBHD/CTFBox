...
class Users(object):
    ...
    def getPasswordHashes(self):
        ...
        if not kb.data.cachedUsersPasswords:
            ...
            message = '你想执行基于字典的攻击吗 '
            message += '针对检索到的密码哈希值？ [是/否/q]'
        ...
        if not kb.data.cachedUsersPrivileges and isInferenceAvailable() and not conf.direct:
            ...
            for user in users:
                ...
                for index in indexRange:
                    ...
                    # 在 PostgreSQL 中，如果权限为 True，我们会得到 1，
                    # 0 otherwise
    ...
    def getRoles(self, query2=False):
        warnMsg = '在%s上没有角色的概念 ' % Backend.getIdentifiedDbms()
        warnMsg += '存在。 sqlmap 将枚举权限'
        logger.warning(warnMsg)
