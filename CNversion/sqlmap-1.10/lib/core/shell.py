    ...
    if os.path.exists(historyPath):
        try:
            ...
            if IS_WIN:
                ...
                warnMsg += '更多信息请参见“https://github.com/pyreadline/pyreadline/issues/30”'
                logger.warning(warnMsg)
...
def autoCompletion(completion=None, os=None, commands=None):
    ...
    if completion == AUTOCOMPLETE_TYPE.OS:
        if os == OS.WINDOWS:
            # 参考号：http://en.wikipedia.org/wiki/List_of_DOS_commands
            ...
            # 参考号：http://en.wikipedia.org/wiki/List_of_Unix_commands
            completer = CompleterNG({
