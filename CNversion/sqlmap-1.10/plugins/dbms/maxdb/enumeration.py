...
class Enumeration(GenericEnumeration):
    ...
    def getPasswordHashes(self):
        warnMsg = '在 SAP MaxDB 上，无法枚举用户密码哈希值'
    ...
    def getPrivileges(self, *args, **kwargs):
        warnMsg = '在 SAP MaxDB 上，无法枚举用户权限'
        logger.warning(warnMsg)

        return {}

    def search(self):
        warnMsg = 'SAP MaxDB 搜索选项不可用'
        logger.warning(warnMsg)

    def getHostname(self):
        warnMsg = '在 SAP MaxDB 上，无法枚举主机名'
        logger.warning(warnMsg)

    def getStatements(self):
        warnMsg = '在 SAP MaxDB 上，无法枚举 SQL 语句'
        logger.warning(warnMsg)
