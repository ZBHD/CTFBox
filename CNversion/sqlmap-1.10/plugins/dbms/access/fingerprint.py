...
class Fingerprint(GenericFingerprint):
    ...
    def _sandBoxCheck(self):
        # 参考号：http://milw0rm.com/papers/198
        retVal = None
        table = None
    ...
    def _sysTablesCheck(self):
        ...
        # Microsoft Access 表参考于 01/2010 更新
        sysTables = {
        ...
        # MSysAccessXML 不是可靠的系统表，因为它并不总是存在
        # （“通过Access访问”，第6页，应该是“通常不存在”而不是“通常为空”）
    ...
    def checkDbms(self):
        ...
        if result:
            ...
            if not result:
                warnMsg = '后端数据库管理系统 不是 %s' % DBMS.ACCESS
