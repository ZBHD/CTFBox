...
def dirtyPatches():
    ...
    # 接受过长的结果行（例如 HTTP 请求头响应中的 SQLi 结果）
    _http_client._MAXLINE = 1 * 1024 * 1024

    # 防止在 sqlmap 分块的情况下进行双分块编码（注意：如果缺少“Content-length”，Python3 会自动执行此操作）
    if six.PY3:
    ...
    # 参考号：https://github.com/nodejs/node/issues/12786#issuecomment-298652440
    codecs.register(lambda name: codecs.lookup("utf-8") if name == "cp65001" else None)

    # 参考号：http://bugs.python.org/issue17849
    ...
    # 参考号：https://github.com/sqlmapproject/sqlmap/issues/4314
    try:
        os.urandom(1)
    ...
    # 参考号：https://github.com/sqlmapproject/sqlmap/issues/5929
    try:
        global collections
    ...
    # 参考号：https://github.com/sqlmapproject/sqlmap/issues/5727
    # 参考号：https://stackoverflow.com/a/14076841
    try:
        import pymysql
    ...
    # 参考号：https://github.com/bottlepy/bottle/blob/df67999584a0e51ec5b691146c7fa4f3c87f5aac/bottle.py
    # 参考号：https://python.readthedocs.io/en/v2.7.2/library/inspect.html#inspect.getargspec
    ...
    # 参考号：https://github.com/sqlmapproject/sqlmap/issues/5731
