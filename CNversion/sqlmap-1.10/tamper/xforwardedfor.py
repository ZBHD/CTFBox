...
def tamper(payload, **kwargs):
    '\n    附加假 HTTP 标头“X-Forwarded-For”（及类似内容）\n    '
    ...
    # 参考号：https://developer.chrome.com/multidevice/data-compression-for-isps#proxy-connection
    headers["Via"] = "1.1 Chrome-Compression-Proxy"

    # 参考号：https://wordpress.org/support/topic/blocked-country-gaining-access-via-cloudflare/#post-9812007
