...
class Fingerprint(GenericFingerprint):
    ...
    def _commentCheck(self):
        ...
        # 参考号：https://downloads.mysql.com/archives/community/
        # 参考号：https://dev.mysql.com/doc/relnotes/mysql/<major>.<minor>/en/
    ...
    def checkDbms(self):
        ...
        * http://dev.mysql.com/doc/refman/6.0/en/news-6-0-x.html (manual has been withdrawn)
        ...
        if result:
            ...
            if not result:
                warnMsg = '后端数据库管理系统 不是 %s' % DBMS.MYSQL
                logger.warning(warnMsg)

                return False

            # 在某些平台上读取 information_schema 会导致恼人的超时退出
            # 参考号：http://bugs.mysql.com/bug.php?id=15855
